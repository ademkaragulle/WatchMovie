    ...
    return (
        <div className='right-side-bar'>
            ...
            <div className='drop-down-menu-items'>
                ...
                <div onClick={() => setIsTrueDropDownMenu(false)}><Button sx={{ width: '100%' }} color='secondary'><Link style={{ width: '100%' }} to={'/movies'} className='drop-down-genres'>Movies</Link></Button></div>
