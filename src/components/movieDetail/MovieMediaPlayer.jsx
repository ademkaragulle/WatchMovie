    ...
    return (
        <div className='movie-media-item'>
            <div onClick={handleClosePosterPath} style={{ display: `${closePosterPath ? 'none' : 'block'}` }} className='media-player-poster-path'>
                ...
                {
                    !movieData.backdrop_path ? <Skeleton /> : <img className='img-fluid-media-player' src={`https://image.tmdb.org/t/p/original${movieData.backdrop_path}`} alt="" />
                }
